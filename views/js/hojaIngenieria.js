...
function BusquedaItemHojaIng(BusItem) {
  ...
  $.ajax({
    ...
    // GRANALLA
      ...
      $("#Acc_img_int").attr("src","Backend/"+respuesta["Acc_img_int"]);
      $("#Acc_img_ext").attr("src","Backend/"+respuesta["Acc_img_ext"]);
      ...
      RecuperarRectificado(respuesta["ITEM"]);
       ...
       if (respuesta["R_C_Img_Int"]=="views/img/zapata/no_imagen.png" && respuesta["R_C_Img_Ext"]=="views/img/zapata/no_imagen.png") {
        ...
        $("#R_C_Img_Int").append('<img src="Backend/'+respuesta["R_C_Img_Int"]+'" class="img-thumbnail" width="100%">');
        $("#R_C_Img_Ext").append('<b style="font-size: 30px;">No Aplica Ranura y Chaflán</b>');
       } else if (respuesta["R_C_Img_Ext"] != "views/img/zapata/no_imagen.png" && respuesta["R_C_Img_Int"] == "views/img/zapata/no_imagen.png") {
        $("#R_C_Img_Ext").append('<img src="Backend/'+respuesta["R_C_Img_Ext"]+'" class="img-thumbnail" width="100%">');
        $("#R_C_Img_Int").append('<b style="font-size: 30px;">No Aplica Ranura y Chaflán</b>');
       } else {
        $("#R_C_Img_Int").append('<img src="Backend/'+respuesta["R_C_Img_Int"]+'" class="img-thumbnail" width="100%">');
        $("#R_C_Img_Ext").append('<img src="Backend/'+respuesta["R_C_Img_Ext"]+'" class="img-thumbnail" width="100%">');
      ...
      RecuperarAccesorios(respuesta["ITEM"]);
       ...
       $(".Emp_Img").attr("src","Backend/"+respuesta["Emp_Img"]);

       
       if (respuesta["Emp_PDF"] == "") {

       } else {
        $(".visualizarPDFEmpaque").attr("src","Backend/"+respuesta["Emp_PDF"]);
      ...
      success: function(respuesta){ 
        ...
        respuesta.forEach(function (respuesta, index) {
          ...
          if (respuesta[0].A_usar == "Misma Zapata a usar") {
            $("#img_zapata_Int").append('<img src="Backend/'+respuesta[0].Img_Int_1+'" class="img-fluid rounded" style="width: 100%;">');
              // NOTAS GENERALES
            ...
            // IMAGEN EXTERIOR
            $("#img_zapata_Ext").append('<img src="Backend/views/img/zapata/misma_usar.png" class="img-fluid rounded" style="width: 100%;">');
          } else {
            // IMAGEN INTERIOR
            $("#img_zapata_Int").append('<img src="Backend/'+respuesta[0].Img_Int_1+'" class="img-fluid rounded" style="width: 100%;">');
            if (respuesta[0].Notas_Generales != "") {
            ...
            // IMAGEN EXTERIOR
            $("#img_zapata_Ext").append('<img src="Backend/'+respuesta[0].Img_Ext_1+'" class="img-fluid rounded" style="width: 100%;">');
          }
          $(".visualizarNotaGeneralZapata").attr("src","Backend/"+respuesta[0].Pdf_Notas_Generales);
    ...
    $.ajax({
      ...
      success: function(respuesta){
        ...
        if (respuesta["Notas"] != "" && respuesta["Archivo_Pdf"] != "") {
          $(".visualizarNotaGeneralMoldePrensa").attr("src","Backend/"+respuesta["Archivo_Pdf"]);
    ...
    $.ajax({
      ...
      success: function(respuesta){
       ...
       if (respuesta["Observaciones"] != "" && respuesta["Archivo_Pdf"] != "" ) {
        console.log("1");
        $(".visualizarPDFRectificado").attr("src","Backend/"+respuesta["Archivo_Pdf"]);
...
/*=============================================
  ...
  =============================================*/  
function RecuperarShim(ITEM_Hoja_Ing_Shim) {
  // console.log(ITEM_Hoja_Ing_zapta);
  $(".mostarShim").empty();
  $("#notaShim").empty();
  // $("#img_zapata_Int").empty();
    ...
    $.ajax({
      ...
      success: function(respuesta){ 
        ...
        if (respuesta[0].Doc_pdf == 0) {
          ...
          $(".visualizarNotaGeneralShim").attr("src","Backend/"+respuesta[0].Doc_pdf);
...
function RecuperarAccesorios(ITEM_Hoja_Ing_Accesorio) {
  ...
  var datos = new FormData();
    ...
    $.ajax({
      ...
      dataType: "json",
      success: function(respuesta){ 
        console.log("Accesorios", respuesta);
