<div class="content-wrapper"> 
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Encuesta 360° </li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Encuesta 360°</h3>
        ...
        <div class="box-body">
            ...
            <form method="post" id="360Encuesta">
            ...
            <tbody>
              <tr class="text-center">
                ...
                <th>
                  <div class="radio">
                    <label>
                      <input type="radio" name="optionsRadios1" id="optionsRadios15" value="0">
                    </label>
                  </div>
                </th>
              </tr>
