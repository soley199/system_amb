...
class modeloRecepcionMaterial{
	...
	static public function MdlInsertarAvisoRecepcionRevisado($tabla, $item, $valId_RecepcionMaterial, $valCantidad_llegada, $valConducto, $valObservaciones, $valCertificado_Calidad){
		$stmt = Conexion::conectar()->prepare("CALL proc_AvisoRecepcionRevisarTerminar(:valId_RecepcionMaterial, :valCantidad_llegada, :valConducto, :valObservaciones, :valCertificado_Calidad)");
