  ...
  if (accion == "inicio") {
    ...
    $.ajax({
      ...
      success: function(respuesta) {
        ...
        $("#des_RevisarRecepcionFacturaAvisoRecepcion").text(respuesta["Factura"]);
      }
    })
  } else {
  ...
  $(".tableRecepcionMaterialTerminada").on("click", ".btnEnviarLabRecepcionMaterial",
    function() {
      ...
      $.ajax({
        ...
        dataType: "json",
        success: function(respuesta) {
          console.log("Laboratorio Enviar", respuesta);
          ...
          $("#des_EnviarLabFacturaAvisoRecepcion").text(respuesta["Factura"])
