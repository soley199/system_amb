      ...
      <section class="content">
        ...
        <div class="row">
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a data-toggle="tab" href="#BackCanaBrake">CANABRAKE</a></li>
            <li><a data-toggle="tab" href="#BackLuk">LUK</a></li>
            <li><a data-toggle="tab" href="#BackNapa">NAPA</a></li>
            ...
            <li><a data-toggle="tab" href="#BackGhoner">GHONER</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="BackNapa">
              <section class="content-header">
                <h1>NAPA</h1>
                <div class="col-md-12">
                  <table class="table table-striped">
            ...
            <div class="tab-pane fade in" id="BackGhoner">
              <section class="content-header">
                <h1>Ghoner</h1>
                <div class="col-md-12">
                  <table class="table table-striped">
