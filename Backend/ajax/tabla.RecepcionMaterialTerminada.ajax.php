<?php
	...
	class AjaxTablaRecepcionMaterialTerminada{

		public function MostrarTabla(){
			$RecepMaterial = controladorRecepcionMaterial::ctrMostrarRecepcionMaterialTerminada();
			...
			$datosJson = '{
				...
				} else if($RecepMaterial[$i]["Estatus"] == "Enviado Laboratorio") {
				...
				=            BOTONES            =
				=============================================*/
				$botones = "<div class='btn-group'><button class='btn btn-warning btn-sm btnEnviarLabRecepcionMaterial' id='btnEnviarLabRecepcionMaterial' RecepcionMaterialFacturaEnviarLab='".$RecepMaterial[$i]["Factura"]."'><i class='fa fa-check-square-o'></i></button><button class='btn btn-primary btn-sm btnImprimirRecepcionMaterial' RecepcionMaterialFacturaEnviarLab='".$RecepMaterial[$i]["Factura"]."'><i class='fa fa-print'></i></button></div>";
	...
	$activar = new AjaxTablaRecepcionMaterialTerminada();
