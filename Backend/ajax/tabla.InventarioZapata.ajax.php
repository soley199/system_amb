<?php
	...
	class AjaxTablaInventarioZapata{
		...
		public function MostrarTabla(){
			$item = null;
      $valor = null;
			$Inventario_Zapata = controladorInventarioMateriaPrima::ctrMostrarInventarioZapata($item, $valor);
			...
			$datosJson = '{
				...
				=            BOTONES            =
				=============================================*/
				$botones = "<div class='btn-group'><button class='btn btn-warning btn-sm btnEditaCantidadZapata' Id_Inventario_Zapata='".$Inventario_Zapata[$i]["Id_Producto"]."'><i class='fa fa-pencil-square-o'></i></button></div>";
